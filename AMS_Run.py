...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec_delete, fg="black", bg="#FFA900", width=9, height=1, activebackground="Red",
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def err_screen1():
                ...
                Button(errsc2, text='OK', command=del_errsc2, fg="black", bg="#FFA900", width=9, height=1,
            ...
            ENR = tk.Label(MFW, text="Enter Enrollment", width=15, height=2, fg="white", bg="#C65D7B",
                           font=('times', 15, ' bold '))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Student name", width=15, height=2, fg="white", bg="#C65D7B",
                                font=('times', 15, ' bold '))
            STU_NAME.place(x=30, y=200)

            global ENR_ENTRY
            ENR_ENTRY = tk.Entry(MFW, width=20,validate='key', bg="#DADBBD", fg="red", font=('times', 23, ' bold '))
            ...
            STUDENT_ENTRY = tk.Entry(MFW, width=20, bg="#DADBBD", fg="red", font=('times', 23, ' bold '))
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            ...
                            label = tkinter.Label(root, width=13, height=1, fg="black", font=('times', 13, ' bold '),
                                                  bg="#FFA900", text=row, relief=tkinter.RIDGE)
            ...
            c1ear_enroll = tk.Button(MFW, text="Clear", command=remove_enr, fg="black", bg="#F68989", width=10,
                                     height=1,
                                     activebackground="Red", font=('times', 15, ' bold '))
            c1ear_enroll.place(x=690, y=100)

            c1ear_student = tk.Button(MFW, text="Clear", command=remove_student, fg="black", bg="#F68989", width=10,
                                      height=1,
                                      activebackground="Red", font=('times', 15, ' bold '))
            c1ear_student.place(x=690, y=200)

            DATA_SUB = tk.Button(MFW, text="Enter Data",command=enter_data_DB, fg="black", bg="#FFA900", width=20,
                                 height=2,
                                 activebackground="Red", font=('times', 15, ' bold '))
    ...
    SUB = tk.Label(sb, text="Enter Subject", width=15, height=2, fg="white", bg="#C65D7B", font=('times', 15, ' bold '))
    SUB.place(x=30, y=100)

    global SUB_ENTRY

    SUB_ENTRY = tk.Entry(sb, width=20, bg="#DADBBD", fg="red", font=('times', 23, ' bold '))
    SUB_ENTRY.place(x=250, y=105)

    fill_manual_attendance = tk.Button(sb, text="Fill Attendance",command=fill_attendance, fg="white", bg="#F68989", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    Button(sc1,text='OK',command=del_sc1,fg="black"  ,bg="#FFA900"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def err_screen1():
    ...
    Button(sc2,text='OK',command=del_sc2,fg="black"  ,bg="#FFA900"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def subjectchoose():
    ...
    sub = tk.Label(windo, text="Enter Subject", width=15, height=2, fg="white", bg="#C65D7B", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)

    tx = tk.Entry(windo, width=20, bg="#DADBBD", fg="red", font=('times', 23, ' bold '))
    tx.place(x=250, y=105)

    fill_a = tk.Button(windo, text="Fill Attendance", fg="white",command=Fillattendances, bg="#F68989", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    un = tk.Label(win, text="Enter username", width=15, height=2, fg="white", bg="#C65D7B",
                   font=('times', 15, ' bold '))
    un.place(x=30, y=50)

    pw = tk.Label(win, text="Enter password", width=15, height=2, fg="white", bg="#C65D7B",
                  font=('times', 15, ' bold '))
    pw.place(x=30, y=150)
    ...
    un_entr = tk.Entry(win, width=20, bg="#DADBBD", fg="red", font=('times', 23, ' bold '))
    un_entr.place(x=290, y=55)

    def c11():
        pw_entr.delete(first=0, last=22)

    pw_entr = tk.Entry(win, width=20,show="*", bg="#DADBBD", fg="red", font=('times', 23, ' bold '))
    pw_entr.place(x=290, y=155)

    c0 = tk.Button(win, text="Clear", command=c00, fg="black", bg="#F68989", width=10, height=1,
                            activebackground="Red", font=('times', 15, ' bold '))
    c0.place(x=690, y=55)

    c1 = tk.Button(win, text="Clear", command=c11, fg="black", bg="#F68989", width=10, height=1,
                   activebackground="Red", font=('times', 15, ' bold '))
    c1.place(x=690, y=155)

    Login = tk.Button(win, text="LogIn", fg="black", bg="#FFA900", width=20,
                       height=2,
...
message = tk.Label(window, text="AKGEC-Attendance-Management-System", bg="#F6E7D8", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2, fg="black", bg="#F68989", font=('times', 15, ' bold '))
...
txt = tk.Entry(window, validate="key", width=20, bg="#DADBBD", fg="red", font=('times', 25, ' bold '))
txt['validatecommand'] = (txt.register(testVal),'%P','%d')
txt.place(x=550, y=210)

lbl2 = tk.Label(window, text="Enter Name", width=20, fg="black", bg="#F68989", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="#DADBBD", fg="red", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

# clearButton = tk.Button(window, text="Clear",command=clear,fg="black"  ,bg="#F68989"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
# clearButton.place(x=950, y=210)

# clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="#F68989"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
...
takeImg = tk.Button(window, text="Take Images",command=take_img,fg="white"  ,bg="#C65D7B"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="#FFA900"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance",fg="white",command=subjectchoose  ,bg="#C65D7B"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill  ,fg="black"  ,bg="#FFA900"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
